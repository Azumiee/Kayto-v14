...
module.exports = {
    ...
    cooldown: 10000,
        ...
        const initialEmbed = new EmbedBuilder()
            .setTitle('Help page of Kayto 📚')
            .setURL('https://discord.gg/..')
            .setDescription('Below, you will find a menu with several categories that explains all of **my commands**. ⌚\n\n> If you have any questions about the bot, please join the [**Kayto\'s Server**](https://discord.gg/..)')
            ...
            const buttonsRow = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder()
                        ...
                        .setURL('https://discord.com/api/oauth2/authorize?client_id=...&permissions=8&scope=bot+applications.commands'),
                    new ButtonBuilder()
