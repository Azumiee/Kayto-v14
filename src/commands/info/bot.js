...
module.exports = {
    ...
    async run(client, interaction) {
        ...
        switch (subCommand) {
            ...
            case 'author': {
                const authorDescription = `Hey there, I'm **Kayto**! My developer/creator is **Azumie**. My goal is to liven up your server by bringing entertainment and good vibes, always ready to brighten your day ${emojis.love}`;
                const discordUserUrl = `https://discord.com/users/488306255647997952`;
                const botAvatarUrl = client.user.displayAvatarURL({ dynamic: true, size: 1024 });
